...
*Convention for the origin of the angles*: The orientation angles &rho; (for sticks and histograms) are computed counter-clockwise in the field of view using the convention specified in the following image, related to the field of view. Please also note the numbering of the pixels in the horizontal and vertical axes. For 4polar methods, the angle &eta; 
